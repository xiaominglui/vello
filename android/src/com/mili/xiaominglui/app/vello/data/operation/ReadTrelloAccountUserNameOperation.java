...
import com.mili.xiaominglui.app.vello.data.factory.ReadTrelloAccountUserNameResponseJsonFactory;
import com.mili.xiaominglui.app.vello.data.requestmanager.VelloRequestFactory;

public class ReadTrelloAccountUserNameOperation implements Operation {
    private static final String TAG = ReadTrelloAccountUserNameOperation.class.getSimpleName();
    ...
    public Bundle execute(Context context, Request request) throws ConnectionException, DataException, CustomRequestException {
        ...
        return ReadTrelloAccountUserNameResponseJsonFactory.parseResult(result.body);
    }
