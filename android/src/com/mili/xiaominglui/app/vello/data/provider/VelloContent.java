...
public class VelloContent {
    ...
    public static final class DbWordCard extends VelloContent {
        ...
        public static enum Columns implements ColumnMetadata {
            ID(BaseColumns._ID, "INTEGER"), ID_CARD("card_id", "VARCHAR"), NAME(
                    "name", "VARCHAR"), DESC("desc", "VARCHAR"), DUE("due",
                    "VARCHAR"), CLOSED("closed", "SMALLINT"), ID_LIST(
                    "list_id", "VARCHAR"), DATE_LAST_ACTIVITY(
                    "dateLastActivity", "VARCHAR"), SYNCINNEXT("syncInNext",
                    "SMALLINT");
        ...
        public static final String[] PROJECTION = new String[] {
                Columns.ID.getName(), Columns.ID_CARD.getName(),
        ...
        public static void createTable(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + TABLE_NAME + " ("
                    ...
                    + Columns.ID_CARD.getType() + ", " + Columns.NAME.getName()
                    + " " + Columns.NAME.getType() + ", "
                    + Columns.DESC.getName() + " " + Columns.DESC.getType()
                    + ", " + Columns.DUE.getName() + " "
                    + Columns.DUE.getType() + ", " + Columns.CLOSED.getName()
                    + " " + Columns.CLOSED.getType() + ", "
                    + Columns.SYNCINNEXT.getName() + " "
                    + Columns.SYNCINNEXT.getType() + ", "
                    + Columns.ID_LIST.getName() + " " + Columns.ID_LIST.mType
                    + ", " + Columns.DATE_LAST_ACTIVITY.getName() + " "
