...
public class TrelloBoardListJsonFactory {
    private static final String TAG = TrelloBoardListJsonFactory.class.getSimpleName();
	...
	bundle.putParcelableArrayList(VelloRequestFactory.BUNDLE_EXTRA_TRELLO_BOARD_LIST, boardList);
	return bundle;
    }
