...
import com.mili.xiaominglui.app.vello.data.factory.ReviewedPlusWordCardResponseJsonFactory;
...
public class ReviewedPlusWordCardOperation implements Operation {
    private static final String TAG = ReviewedPlusWordCardOperation.class
            .getSimpleName();
    ...
    public Bundle execute(Context context, Request request) throws ConnectionException,
        ...
        return ReviewedPlusWordCardResponseJsonFactory.parseResult(result.body);
    }
