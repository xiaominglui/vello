...
import com.mili.xiaominglui.app.vello.data.factory.ArchiveWordCardResponseJsonFactory;
import com.mili.xiaominglui.app.vello.data.factory.ReviewedWordCardResponseJsonFactory;
import com.mili.xiaominglui.app.vello.data.requestmanager.VelloRequestFactory;
import com.mili.xiaominglui.app.vello.util.AccountUtils;

public class ArchiveWordCardOperation implements Operation {
	private static final String TAG = ArchiveWordCardOperation.class
		    .getSimpleName();
	...
	public Bundle execute(Context context, Request request)
		...
		return ArchiveWordCardResponseJsonFactory.parseResult(result.body);
	}
