...
public final class VelloRequestFactory {
    ...
    public static final int REQUEST_TYPE_SYNC_LOCAL_CACHE = 16;
    ...
    public static Request syncLocalCacheRequest() {
    	Request request = new Request(REQUEST_TYPE_SYNC_LOCAL_CACHE);
