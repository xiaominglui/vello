...
public class AllWordCardListJsonFactory {
    private static final String TAG = AllWordCardListJsonFactory.class.getSimpleName();

    public static ArrayList<WordCard> parseResult(String wsResponse) throws DataException {
