...
public class CheckVocabularyListOperation implements Operation {
    private static final String TAG = CheckVocabularyListOperation.class.getSimpleName();
	...
	String urlString = WSConfig.TRELLO_API_URL
		...
		+ WSConfig.WS_TRELLO_FIELD_LISTS;
	
	HashMap<String, String> parameterMap = new HashMap<String, String>();
	parameterMap.put(WSConfig.WS_TRELLO_PARAM_FILTER, "all");
	parameterMap.put(WSConfig.WS_TRELLO_PARAM_FIELDS, "name,closed");
	parameterMap.put(WSConfig.WS_TRELLO_PARAM_CARDS, "none");
	...
	return VocabularyListJsonFactory.parseResult(result.body);
    }
