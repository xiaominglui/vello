...
import com.mili.xiaominglui.app.vello.data.factory.ConfigureBoardResponseJsonFactory;
import com.mili.xiaominglui.app.vello.data.requestmanager.VelloRequestFactory;
import com.mili.xiaominglui.app.vello.util.AccountUtils;

import java.util.HashMap;

public class ConfigureVocabularyBoardOperation implements Operation {
    private static final String TAG = ConfigureVocabularyBoardOperation.class.getSimpleName();

    @Override
    public Bundle execute(Context context, Request request)
	    throws ConnectionException, DataException, CustomRequestException {
	String token = AccountUtils.getAuthToken(context);
	String vocabularyBoardId = request.getString(VelloRequestFactory.PARAM_EXTRA_VOCABULARY_BOARD_ID);
	...
	return ConfigureBoardResponseJsonFactory.parseResult(result.body);
    }
