...
public class CreateVocabularyBoardOperation implements Operation {
	...
	String vocabularyBoardName = AccountUtils.getVocabularyBoardName(context);
	String verification = AccountUtils.getVocabularyBoardVerification();
	
	String urlString = WSConfig.TRELLO_API_URL + WSConfig.WS_TRELLO_TARGET_BOARD;
	
	HashMap<String, String> parameterMap = new HashMap<String, String>();
	parameterMap.put(WSConfig.WS_TRELLO_PARAM_NAME, vocabularyBoardName);
	parameterMap.put(WSConfig.WS_TRELLO_PARAM_DESC, verification);
	...
	return CreateVocabularyBoardResponseJsonFactory.parseResult(result.body);
    }
