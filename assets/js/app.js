...
(function() {
  ...
  jQuery(function($) {
    ...
    Filter = (function(_super) {
      ...
      Filter.prototype.toStringForGaEvent = function() {
        var params;
    ...
    FilterView = (function(_super) {
      ...
      FilterView.prototype.filterChanged = function(e) {
        var displayFlags;
        displayFlags = [];
      ...
      FilterView.prototype.resetSearch = function() {
        return this.model.set("search", "");
      };

      FilterView.prototype.updateSearchStatus = function() {
        this.$el.find('.search').toggleClass('empty', !this.model.get('search'));
        return this.$('[name=search]').val(this.model.get('search'));
      };

      FilterView.prototype.gaTrackChangeEvent = function() {
        return _gaq.push(['_trackEvent', 'Filters', 'Change', this.model.toStringForGaEvent()]);
      };
      ...
      */
      ...
      Card.prototype.matchesFilter = function(filter) {
        ...
        if (filter.get('search')) {
          result &= card.get('name').toLowerCase().indexOf(filter.get('search')) !== -1;
        }
        return result;
      };
